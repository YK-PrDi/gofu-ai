...
public class ImageGenerationService {
    ...
    private String buildCustomPromptAnalysisPrompt(String prompt, int count, boolean hasImage, boolean withText) {
        ...
        String compositionExamples = """
                ...
                - 近景特写 + 手部演示动作(握持/按压/抽拉/拧动), 配橙色环形波纹或发光轮廓特效突出操作部件。**手部必须逻辑自洽·物理正确**：出现的手必须正在完整、明确地握住或操作产品(手指真实包裹接触点、抓握姿势符合该动作)，产品由手或支撑面稳定托住；严禁出现"手已松开/拿下却仍悬在产品旁""半截手臂无身体""手悬空不接触产品""手指穿过外壳/孔洞"等违和残手。若手部动作与该产品不契合或没把握画对，宁可不加手、只做无手的纯产品近景特写。
